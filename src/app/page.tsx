...
export default function Home() {
  ...
  const sonnyImages = [
    {
      src: "https://res.cloudinary.com/dfzfma2i9/image/upload/v1745164505/sonny-angels/myrul3i6cjtrb5j8lqas.jpg",
      alt: "Sonny Angel 1",
    ...
    {
      src: "https://toysez.com/cdn/shop/files/2_a4854696-3661-4e23-a2a9-2c3a98daaaa5.jpg?v=1704196650",
      alt: "Sonny Angel 3",
  ...
  const sonnyImages2 = [
    {
      src: "https://toysez.com/cdn/shop/files/IMG_9531.jpg?v=1702240660",
      alt: "Sonny Angel 8",
      series: "Marine Series",
      title: "Dolphin",
      price: "$16.99",
    ...
    {
      src: "https://res.cloudinary.com/dfzfma2i9/image/upload/v1745163129/sonny-angels/moeuo1who5aitbktwgj4.webp",
      alt: "Sonny Angel 9",
      series: "Marine Series",
      title: "Octopus",
      price: "$15.99",
                  ...
                  {sonnyImages2.map((image, index) => (
                    <CarouselItem key={index} className="pl-2 basis-1/6">
                      <Link
                        href={
                          index === 0
                            ? "/profile/183bea63-3b13-4306-8c8a-9fb34bda6572/listing/65c5f04b-c2dc-4001-82fa-43d1badd96c0"
                            : index === 1
                            ? "/profile/183bea63-3b13-4306-8c8a-9fb34bda6572/listing/516aec3f-5036-4d55-84b6-5df6da2a26e3"
                            : `/listings/${index + 100}`
                        }
                        ...
                        <div className="p-1">
                          <div className="w-full">
                            ...
                            <div className="mt-2 space-y-1">
                              <p className="text-xs sm:text-sm font-medium text-gray-900 line-clamp-1 group-hover:text-blue-600 transition-colors">
                    ...
                    <Link
                      href={
                        index === 0
                          ? "/profile/183bea63-3b13-4306-8c8a-9fb34bda6572/listing/65c5f04b-c2dc-4001-82fa-43d1badd96c0"
                          : index === 2
                          ? "/profile/e3c6871b-6eec-47f4-92ad-f0fefb95b618/listing/10e1b10a-60a9-4b11-b804-a67f1b29e499"
                          : `/listings/${index}`
                      }
                      className="block group"
                    >
                  ...
                  <Carousel className="w-full">
                    <CarouselContent className="-ml-2">
                      {sonnyImages2.map((image, index) => (
                        <CarouselItem
                          key={index}
                          className="pl-2 md:basis-1/3 basis-1/2"
                        >
                          <div className="p-1">
                            <div className="w-full">
                              <div className="relative aspect-square w-full overflow-hidden rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-blue-100 rounded-xl p-6 space-y-4">
                ...
                <p className="text-gray-600 text-sm">
                  Sonny Angels are shipped to our facilities for verification
              ...
              <div className="bg-blue-100 rounded-xl p-6 space-y-4">
                ...
                <p className="text-gray-600 text-sm">
                  We make sure both parties fulfill their trades—if not, your
                  Sonny Angel is returned to you.
                </p>
                <Link
                  href="/learn-more"
                  className="text-blue-600 hover:text-blue-800 text-sm font-medium inline-block"
              ...
              <div className="bg-blue-100 rounded-xl p-6 space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M12.91 4.91a2.764 2.764 0 0 1 0 3.908l-.884.884a7.454 7.454 0 0 0-2.122-2.122l.884-.884a2.764 2.764 0 0 1 3.908 0M16.818 8.818a2.764 2.764 0 0 1 0 3.908l-.884.884a7.454 7.454 0 0 0-2.122-2.122l.884-.884a2.764 2.764 0 0 1 3.908 0M8.818 16.818a2.764 2.764 0 0 1 0 3.908l-.884.884a7.454 7.454 0 0 0-2.122-2.122l.884-.884a2.764 2.764 0 0 1 3.908 0M4.91 12.91a2.764 2.764 0 0 1 0 3.908l-.884.884a7.454 7.454 0 0 0-2.122-2.122l.884-.884a2.764 2.764 0 0 1 3.908 0"
                    />
                  </svg>
                  <h3 className="text-xl font-semibold">
                ...
                <p className="text-gray-600 text-sm">
                  We are committed to changing the culture of consumption in the
                  Sonny Angel community.
                </p>
                <Link
                  href="/learn-more"
                  className="text-blue-600 hover:text-blue-800 text-sm font-medium inline-block"
